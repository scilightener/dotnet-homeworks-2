...
[![codecov](https://codecov.io/gh/scilightener/dotnet-homeworks-2/branch/hw13/graph/badge.svg?token=0z7WkggdgM)](https://codecov.io/gh/scilightener/dotnet-homeworks-2)
...
6. После этого в рамках локального репозитория создаётся пулл реквест из ветки с решённым домашним заданием в master. Далее произойдёт автоматический запуск всех workflow:
